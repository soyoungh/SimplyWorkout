...
//  SimplyWorkout
//
//  Created by Soyoung Hyun on 2020/11/10.
//  Copyright © 2020 soyoung hyun. All rights reserved.
//

import UIKit

class X4FontSize: FontSizeProtocol {
    ...
    /// activityName  text - 16 , regular
     ...
     var pickerTextSize: UIFont = UIFont.systemFont(ofSize: 19, weight: .regular)

     /// Configuration header text - 12, light
     var headerTextSize: UIFont = UIFont.systemFont(ofSize: 15, weight: .light)

     /// configuration cell text - 15, regular
     var cellTextSize: UIFont = UIFont.systemFont(ofSize: 18, weight: .regular)
    
    /// Calendar - header title text
    var c_headerTextSize: UIFont = UIFont.systemFont(ofSize: 18, weight: .light)
    
    /// Calendar - weekday text, date text
    var c_weekdayTextSize: UIFont = UIFont.systemFont(ofSize: 15, weight: .light)
