...
class X3FontSize: FontSizeProtocol {
    
    /// activityName  text - 16 , regular
     var bodyTextSize: UIFont = UIFont.systemFont(ofSize: 18, weight: .regular)
     
     /// activity Detail text - 14, light
     var subTextSize: UIFont = UIFont.systemFont(ofSize: 16, weight: .light)
     ...
     var smallestTextSize: UIFont = UIFont.systemFont(ofSize: 14, weight: .regular)

     /// cancel btn, done btn - 15, light
     var btnTextSize: UIFont = UIFont.systemFont(ofSize: 17, weight: .light)

     /// pickerView Label (duration, location) , Configuration Nav bar font -  17, regular
     var pickerTextSize: UIFont = UIFont.systemFont(ofSize: 18, weight: .regular)

     /// Configuration header text - 12, light
     var headerTextSize: UIFont = UIFont.systemFont(ofSize: 14, weight: .light)

     /// configuration cell text - 15, regular
     var cellTextSize: UIFont = UIFont.systemFont(ofSize: 17, weight: .regular)
    
    /// Calendar - header title text
    var c_headerTextSize: UIFont = UIFont.systemFont(ofSize: 17, weight: .light)
    ...
    var add_fieldTextSize: UIFont = UIFont.systemFont(ofSize: 15, weight: .regular)
