...
class DefaultFontSize: FontSizeProtocol {
    
   /// activityName  text - 16 , regular
    var bodyTextSize: UIFont = UIFont.systemFont(ofSize: 16, weight: .regular)
    
    /// activity Detail text - 14, light
    var subTextSize: UIFont = UIFont.systemFont(ofSize: 14, weight: .light)
    
    /// duration, location, dateLabel -13, regular
    var extraTextSize: UIFont = UIFont.systemFont(ofSize: 13, weight: .regular)
    
    /// intensityLabel -12, regular
    var smallestTextSize: UIFont = UIFont.systemFont(ofSize: 12, weight: .regular)

    /// cancel btn, done btn - 15, light
    var btnTextSize: UIFont = UIFont.systemFont(ofSize: 15, weight: .light)
    ...
    var headerTextSize: UIFont = UIFont.systemFont(ofSize: 12, weight: .light)

    /// configuration cell text - 15, regular
    var cellTextSize: UIFont = UIFont.systemFont(ofSize: 15, weight: .regular)
    ...
    var c_weekdayTextSize: UIFont = UIFont.systemFont(ofSize: 13, weight: .light)
